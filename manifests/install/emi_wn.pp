  ...
  if $::cern_network_domain {
    case $::operatingsystemmajorrelease {
      5       : {
        ...
        package { ['dpm-libs', 'dpm-devel', 'dpm-perl', 'dpm-python', 'dpm-python26']: ensure => present, }
      ...
      6       : {
        ...
        package { ['dpm-libs', 'dpm-devel', 'dpm-perl', 'dpm-python']: ensure => present, }
      ...
      default : {
        package { 'emi-wn': ensure => present, }
      }
    }
  } else {
    #
    # for all other cases we follow the standard procedures
    #
    package { 'emi-wn': ensure => present, }
  }
}
